...
function MorunoRank()
	...
	if chatRPT then
			DEFAULT_CHAT_FRAME:AddMessage("Current RP: "..CurrentRP.." at "..PercentPVPRank.."% (Rank "..CurrentRank..") RP To Next Rank: "..NeededRPToNextRank.." This Week RP Gained:"..math.floor(RB).." @ Total RP Calculation: "..EEarns.." ", 1, 0.647059, 0);
			chatRPT = false;
			else DEFAULT_CHAT_FRAME:AddMessage("Current RP: "..CurrentRP.." at "..PercentPVPRank.."% (Rank "..CurrentRank..") RP To Next Rank: "..NeededRPToNextRank.." This Week RP Gained:"..math.floor(RB).." @ Total RP Calculation: "..EEarns.." at "..PercentNextPVPRank.."%(Rank "..EarnedRank..")",   1, 0.647059, 0);
		end		
...
--SLASH CMD
function Slash(msg, self) 	
	if msg == "r" or msg == "full" then
		chatRPT = true;
		MorunoRank(); 
	else
		MorunoRank(); 
...
function SlashHelp() 	
	DEFAULT_CHAT_FRAME:AddMessage("Slash command |cFF00FF00 /mr |ror create macro |cFF00FF00MorunoRank(); |rfor |cFFFFFF66short |rreport.")
	DEFAULT_CHAT_FRAME:AddMessage("You can also use |cFF00FFCC/mr r |ror |cFF00FFCC/mr full |rto see |cFFFFFF66full |rreport of MorunoRank.")
end

SLASH_MR1 = '/mr';
SlashCmdList["MR"] = function (msg) Slash(msg) end

SLASH_MRHELP1 = '/MorunoRank';
SlashCmdList["MRHELP"] = function() SlashHelp() end
--SLASH CMD END
end)
